...

{
  ...
  programs.fish = {
    ...
    shellAliases = {
      ...
      pi-sandbox = "~/Codes/agent-sandbox/run-container.sh pi";
      opencode-sandbox = "~/Codes/agent-sandbox/run-container.sh opencode";
      claude-sandbox = "~/Desktop/Codes/agent-sandbox/run-container.sh claude";
      cursor-sandbox = "~/Desktop/Codes/agent-sandbox/run-container.sh cursor";
    };
