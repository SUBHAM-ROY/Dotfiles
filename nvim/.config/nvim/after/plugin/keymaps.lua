...
vim.keymap.set('t', '<C-q>', '<C-\\><C-n>', opts) -- Exit terminal mode with Ctrl+q
...
-- Do not yank on change
vim.keymap.set('n', 'c', '"_c', opts)
vim.keymap.set('n', 'C', '"_C', opts)
vim.keymap.set('n', 'cc', '"_cc', opts)

-- Plugin management
vim.keymap.set('n', '<leader>U', function() vim.pack.update() end, { desc = 'Update Plugins' })
